...
class image_operations():
    def __init__(self):        
        ...
        self.file_id, self.file_extension = os.path.splitext(self.files[0]) #self.file_extension of uploaded image
        self.image_path = os.path.join(self.APP_ROOT, 'Images/', self.files[0]) #path of uploaded image        
...
#fil = convolution(plotting=True)
#print(image_operations.convolution.__name__)