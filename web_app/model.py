...
class Methods(db.Model):
    ...
    original_white_point = db.Column(db.Integer, default=255)
    copy_black_point = db.Column(db.Integer,default=0)
    copy_midetone_slider = db.Column(db.Float, default=1)
    copy_white_point = db.Column(db.Integer, default=255)
    result_black_point = db.Column(db.Integer,default=0)
    result_midetone_slider = db.Column(db.Float, default=1)
    result_white_point = db.Column(db.Integer, default=255)
